...
var LocationPage = /** @class */ (function () {
    ...
    LocationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-location',template:/*ion-inline-start:"/sh3wza/hdaeq-master/src/pages/location/location.html"*/'\n  <ion-header>\n\n      <ion-navbar>\n        <ion-title>{{ \'selectlocation\' | translate }}</ion-title>\n      </ion-navbar>\n    </ion-header>\n  \n  <ion-content>\n  \n    <div class="body">\n      <div #map id="map"></div>\n      <button class="btn-button bg-green" (click)="dismiss()">{{ \'confirm\' | translate }}</button>\n    </div>\n  \n  </ion-content>\n  '/*ion-inline-end:"/sh3wza/hdaeq-master/src/pages/location/location.html"*/,
        }),

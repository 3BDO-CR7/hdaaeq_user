...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_location__ = __webpack_require__(888);
...
var SelectLocationPage = /** @class */ (function () {
    ...
    SelectLocationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-select-location',template:/*ion-inline-start:"/sh3wza/hdaeq-master/src/pages/select-location/select-location.html"*/'\n  <ion-header>\n\n      <ion-navbar>\n        <ion-title>{{ \'selectlocation\' | translate }}</ion-title>\n      </ion-navbar>\n    </ion-header>\n  \n  <ion-content>\n  \n    <div class="body">\n      <div #map id="map"></div>\n      <button [disabled]="model.lat ==\'\' || model.lng == \'\' " class="btn-button bg-green" (click)="dismiss()">{{ \'confirm\' | translate }}</button>\n    </div>\n  \n  </ion-content>\n  '/*ion-inline-end:"/sh3wza/hdaeq-master/src/pages/select-location/select-location.html"*/,
        }),

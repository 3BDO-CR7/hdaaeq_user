...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__flowers_section__ = __webpack_require__(874);
...
var FlowersSectionPage = /** @class */ (function () {
    ...
    FlowersSectionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-flowers-section',template:/*ion-inline-start:"/sh3wza/hdaeq-master/src/pages/flowers-section/flowers-section.html"*/'<ion-header>\n\n    <ion-navbar>\n      <ion-title>{{ \'ourflowers\' | translate }}</ion-title>\n    </ion-navbar>\n\n    <div class="block-body">\n        <div class="body-app shadow">\n        \n            <div class="form-section">\n                <div class="upload-image">\n                    <h3 *ngFor="let serv of serves">\n                        <div (click)="goService( serv?.name , serv?.id , serv?.unit)">\n                            {{ serv?.name }}\n                        </div>\n                    </h3>\n                </div>\n            </div>\n        </div>\n    </div>\n\n  </ion-header>\n\n<ion-content padding>\n\n  \n\n</ion-content>\n'/*ion-inline-end:"/sh3wza/hdaeq-master/src/pages/flowers-section/flowers-section.html"*/,
        }),
